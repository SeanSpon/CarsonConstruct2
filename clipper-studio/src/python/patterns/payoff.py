...
def detect_payoff_moments(features: Dict, bounds: Dict, settings: Dict) -> List[Dict]:
    """
    ...
    for silence in silence_regions:
        ...
        silence_score = min(40.0, (silence["duration"] / 5.0) * 40.0)
        spike_score = min(60.0, max(0.0, (spike_intensity - 1.0)) * 30.0)
        algorithm_score = silence_score + spike_score

        clip_start = max(start_time, silence["start"] - 3.0)
        ...
        clip = {
            ...
            "score": round(min(100, algorithm_score), 1),
            ...
            "silence_duration": round(silence["duration"], 2),
